        ...
        try {
          ...
          const response = await this.malApi.getAnimeList({
            animeList: [
              ...
              'synopsis', 'mean', 'genres', 'media_type', 'status', 'num_episodes', 'start_season',
              'studios', 'my_list_status', 'updated_at'
            ]
          }, status)
      ...
      if (existingAnime && !forceUpdate) {
        ...
        if (hoursSinceLastSync < 24) {
          ...
          return
              ...
              // Prepare optimized anime data for database (only essential fields)
        const animeDbData = {
