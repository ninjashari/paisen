...
class AnimeMatchingService {
  ...
  /**
   * Match anime by AniDB ID (requires external mapping service)
   * 
   * @param {string} anidbId - AniDB ID
   * @returns {Promise<Object|null>} MAL anime entry or null
   */
  async matchByAniDbId(anidbId) {
    // This would require an external mapping service like anime-offline-database
    // For now, we'll skip this implementation
    console.log(`AniDB matching not implemented for ID: ${anidbId}`)
    return null
  }
